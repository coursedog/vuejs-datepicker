...
proto$1.set = set; // Eras
proto$1.eras = localeEras;
proto$1.erasParse = localeErasParse;
proto$1.erasConvertYear = localeErasConvertYear;
proto$1.erasAbbrRegex = erasAbbrRegex;
proto$1.erasNameRegex = erasNameRegex;
proto$1.erasNarrowRegex = erasNarrowRegex; // Month
...
var utils = {
  ...
  getDayNameAbbr: function getDayNameAbbr(date) {
    ...
    return hooks().setDay(this.getDay(date)).locale(this.language).format('ddd');
  },
  ...
  getMonthName: function getMonthName(date) {
    var parser = this.useUtc ? hooks.utc : hooks;
  ...
  formatDate: function formatDate(date, format) {
    return hooks(date).locale(this.language).format(format);
  },
